import { getHouses, updateNumbers, sortByChildren, hasChildrenEntries, totalCharacters } from './object-keys-2.js';
...
test('You will have an array of objects which you will sort through. The houses are sorted by amount of children ', () => {
  const characters = [
    {
      name: 'Eddard',
      spouse: 'Catelyn',
