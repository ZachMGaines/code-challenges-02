import { getHouses, updateNumbers } from './object-keys-2.js';
...
test('it changes objects into an array of strings', () => {
  const object = { 'Grace Hopper': '222-303-5938', 'Ada Lovelace': '222-349-9842', 'Alan Turing': '222-853-5933' };
  const output = updateNumbers(object);
